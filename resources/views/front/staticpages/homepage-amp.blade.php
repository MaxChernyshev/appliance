        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-6 col-md-3 col-lg-2 services-item">
                    <amp-img height="55px" width="55px" src="{{ asset('/assets/front/images/services/refrigerator.svg' ) }}" alt="refrigerator"></amp-img>
                    <p>Refrigerator Repair</p>
                </div>
                <div class="col-6 col-md-3 col-lg-2 services-item">
                    <amp-img height="55px" width="55px" src="{{ asset('/assets/front/images/services/wine-cooler.svg' ) }}" alt="wine-cooler"></amp-img>
                    <p>Wine Cooler Repair</p>
                </div>
                <div class="col-6 col-md-3 col-lg-2 services-item">
                    <amp-img height="55px" width="55px" src="{{ asset('/assets/front/images/services/ice-maker.svg' ) }}" alt="ice-maker"></amp-img>
                    <p>Ice-Maker <br> Repair</p>
                </div>
                <div class="col-6 col-md-3 col-lg-2 services-item">
                    <amp-img height="55px" width="55px" src="{{ asset('/assets/front/images/services/freezer.svg' ) }}" alt="freezer"></amp-img>
                    <p>Freezer <br> Repair</p>
                </div>
                <div class="col-6 col-md-3 col-lg-2 services-item">
                    <amp-img height="55px" width="55px" src="{{ asset('/assets/front/images/services/garbage-disposal.svg' ) }}" alt="garbage-disposal"></amp-img>
                    <p>Garbage Disposal Repair</p>
                </div>
                <div class="col-6 col-md-3 col-lg-2 services-item">
                    <amp-img height="55px" width="55px" src="{{ asset('/assets/front/images/services/dryer.svg' ) }}" alt="dryer"></amp-img>
                    <p>Dryer <br> Repair</p>
                </div>
                <div class="col-6 col-md-3 col-lg-2 services-item">
                    <amp-img height="55px" width="55px" src="{{ asset('/assets/front/images/services/washer.svg' ) }}" alt="washer"></amp-img>
                    <p>Washer <br> Repair</p>
                </div>
                <div class="col-6 col-md-3 col-lg-2 services-item">
                    <amp-img height="55px" width="55px" src="{{ asset('/assets/front/images/services/dishwasher.svg' ) }}" alt="dishwasher"></amp-img>
                    <p>Dishwasher Repair</p>
                </div>
                <div class="col-6 col-md-3 col-lg-2 services-item">
                    <amp-img height="55px" width="55px" src="{{ asset('/assets/front/images/services/stove.svg' ) }}" alt="stove"></amp-img>
                    <p>Stove <br> Repair</p>
                </div>
                <div class="col-6 col-md-3 col-lg-2 services-item">
                    <amp-img height="55px" width="55px" src="{{ asset('/assets/front/images/services/oven.svg' ) }}" alt="oven"></amp-img>
                    <p>Oven <br> Repair</p>
                </div>
                <div class="col-6 col-md-3 col-lg-2 services-item">
                    <amp-img height="55px" width="55px" src="{{ asset('/assets/front/images/services/microwave.svg' ) }}" alt="microwave"></amp-img>
                    <p>Microwave Repair</p>
                </div>
                <div class="col-6 col-md-3 col-lg-2 services-item">
                    <amp-img height="55px" width="55px" src="{{ asset('/assets/front/images/services/range.svg' ) }}" alt="range"></amp-img>
                    <p>Range <br> Repair</p>
                </div>
            </div>
        </div>
    ...
    <section class="about">
        <div class="container">
            ...
            <div class="row about-item">
                ...
                <div class="col-lg-6">
                    <amp-img layout="responsive" width="525" height="348" src="{{ asset('/assets/front/images/service-1.webp') }}" alt="refrigerator repair service"></amp-img>
                </div>
            </div>
            <div class="row about-item">
                <div class="col-lg-6">
                    <amp-img layout="responsive" width="525" height="348" src="{{ asset('/assets/front/images/service-2.webp') }}" alt="freezer repair service"></amp-img>
                </div>
                <div class="col-lg-6">
            ...
            <div class="row about-item">
                ...
                <div class="col-lg-6">
                    <amp-img layout="responsive" width="525" height="348" src="{{ asset('/assets/front/images/service-3.webp') }}" alt="oven repair service"></amp-img>
                </div>
            </div>
            <div class="row about-item">
                <div class="col-lg-6">
                    <amp-img layout="responsive" width="525" height="348" src="{{ asset('/assets/front/images/service-4.webp') }}" alt="dishwasher repair service"></amp-img>
                </div>
                <div class="col-lg-6">
            ...
            <div class="row about-item">
                ...
                <div class="col-lg-6">
                    <amp-img layout="responsive" width="525" height="348" src="{{ asset('/assets/front/images/service-5.webp') }}" alt="microwave repair service"></amp-img>
                </div>
            </div>
            <div class="row about-item">
                <div class="col-lg-6">
                    <amp-img layout="responsive" width="525" height="348" src="{{ asset('/assets/front/images/service-6.webp') }}" alt="dryer repair service"></amp-img>
                </div>
                <div class="col-lg-6">
            ...
            <div class="row about-item">
                ...
                <div class="col-lg-6">
                    <amp-img layout="responsive" width="525" height="348" src="{{ asset('/assets/front/images/service-7.webp') }}" alt="washer repair service"></amp-img>
                </div>
            </div>
            <div class="row about-item">
                <div class="col-lg-6">
                    <amp-img layout="responsive" width="525" height="348" src="{{ asset('/assets/front/images/service-8.webp') }}" alt="range repair service"></amp-img>
                </div>
                <div class="col-lg-6">
            ...
            <div class="row about-item">
                ...
                <div class="col-lg-6">
                    <amp-img layout="responsive" width="525" height="348" src="{{ asset('/assets/front/images/service-9.webp') }}" alt="ice maker repair service"></amp-img>
                </div>
            </div>
            <div class="row about-item">
                <div class="col-lg-6">
                    <amp-img layout="responsive" width="525" height="348" src="{{ asset('/assets/front/images/service-10.webp') }}" alt="stove repair service"></amp-img>
                </div>
                <div class="col-lg-6">
            ...
            <div class="row about-item">
                ...
                <div class="col-lg-6">
                    <amp-img layout="responsive" width="525" height="348" src="{{ asset('/assets/front/images/service-11.webp') }}" alt="wine cooler repair service"></amp-img>
                </div>
            </div>
        </div>
    </section>
...
{{--                    </form>--}}
                ...
                <div class="col-lg-6">
                    ...
                    <amp-iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d848945.0887342315!2d-118.8595572!3d33.7815461!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x80dd2ad30164cd31%3A0x837d28d6cfbd392a!2sLos%20Angeles%20County%2C%20CA%2C%20USA!5e0!3m2!1sen!2sua!4v1622566823047!5m2!1sen!2sua" width="540" height="450" style="border:0;" sandbox="allow-scripts allow-same-origin" layout="responsive" allowfullscreen=""></amp-iframe>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 advantages-item">
                    <amp-img width="70" height="70" src="{{ asset('/assets/front/images/advantages/pricing.svg' ) }}" alt="pricing"></amp-img>
                ...
                <div class="col-lg-4 advantages-item">
                    <amp-img width="70" height="70" src="{{ asset('/assets/front/images/advantages/medal.svg' ) }}" alt="quality"></amp-img>
                ...
                <div class="col-lg-4 advantages-item">
                    <amp-img width="70" height="70" src="{{ asset('/assets/front/images/advantages/like.svg' ) }}" alt="like"></amp-img>

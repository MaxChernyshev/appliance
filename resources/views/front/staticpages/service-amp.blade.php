@extends('front.layouts.layout-amp')
...
<head>
    ...
    <meta name="description" content="LOS ANGELES, CA REFRIGERATOR REPAIR SERVICE, SAME DAY SERVICE, LICENSED, FREE SERVICE CALL WITH COMPLETED REPAIR, RELIABLE, AFFORDABLE, FACTORY CERTIFIED">
    <title>Affordable Refrigerator Repair Service Los Angeles, Ca</title>
...
<main>
    <amp-sidebar id="sidebar" layout="nodisplay">
        <amp-accordion>
            <section>
                <h4 class="acc-header"><a href="{{ route('homepage-amp') }}">Home</a></h4>
                <span></span>
            </section>
            <section>
                <h4 class="acc-header">Locations</h4>
                <a class="acc-content" href="{{ route('locations-amp') }}">Los Angeles County</a>
            </section>
            <section>
                <h4 class="acc-header"><a href="{{ route('service-amp') }}">Services</a></h4>
                <span></span>
            </section>
            <section>
                <h4 class="acc-header"><a href="{{ route('brand-amp') }}">Brands</a></h4>
                <span></span>
            </section>
        </amp-accordion>
    </amp-sidebar>
        ...
        <section class="hero" style="background:rgba(54, 54, 54, .5) url('/assets/front/images/hero-image.webp') no-repeat center center / cover;">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xl-8">
                        <h1>Dishwasher Repair Los Angeles Ca</h1>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="article">
            <div class="container">
                <div class="row article-item">
                    <div class="col-lg-6">
                        <amp-img layout="responsive" width="525" height="405" src="{{ asset('/assets/front/images/services/108-used-sd.jpg') }}" alt="appliance repairman"></amp-img>
                    </div>
                    <div class="col-lg-6">
                        <p>The acquisition of a dishwasher is difficult and sometimes expensive. Surprisingly, dishwashers are designed to last, and you should hope to somehow get at least 10 years out of yours. And something would probably go wrong if you follow up with the dishwasher.</p>
                        <p>You don't want to take any chances on your dishwasher because it is such an important feature of the kitchen. Repairing the dishwasher on your own can inflict constant damage if you do not understand what you are doing.</p>
                        <p>You're going to like Dishwasher Repair Los Angeles <a href="https://www.ca.gov" rel="dofollow" target="_blank">Ca</a>, three things.</p>
                    </div>
                </div>
                <div class="row article-item">
                    <div class="col-12">
                        <h6>1. Attractiveness</h6>
                        <p>When we first set up our <strong>Los Angeles Ca Dishwasher Repair</strong>, we decided that, at the time, we wouldn't walk in the footsteps of any related businesses in the city. We were going to be exclusive. We were going to be truthful in all of our dealings. If we send an estimation to someone, we respect it. We never, ever give a customer an invoice that contains a slew of unexpected fees at Dishwasher Repair Los Angeles Ca. If more analysis is found than was initially considered necessary, we will let you know immediately what you want to do at Dishwasher Repair Near Me.</p>
                        <h6>2. Experts of the Dishwasher fix</h6>
                        <p>We ensured the highest level of service at <strong>Dishwasher Repair in Los Angeles Ca</strong>. We are doing nothing but making sure they have a passing knowledge of how to fix the appliance as we recruit a new dishwasher repair specialist at Los Angeles Ca Dishwasher Repair. We make certain that they have gained significant experience. The specialist at Dishwasher Repair Near Me will also have full factory qualifications until they are shipped to your home or company. They will be able to evaluate the situation immediately and get down to work.</p>
                        <h6>3. The substitute pieces</h6>
                        <p>Having the best Dishwasher repair near me experts is vital, but they can only do so much if they are dealing with exact details. We have developed a repair that will bear a long life by adhering to a high-quality component that is built to fit your dishwasher with Dishwasher repair Los Angeles Ca.</p>
                    </div>
                </div>
                <div class="row article-item">
                    <div class="col-lg-6">
                        <h2 class="title">Los Angeles Ca Dishwasher Repair</h2>
                        <h5>Why Do You Go with Us?</h5>
                        <p>We provide a variety of services, including but not limited to: Wine Cooler Repair, Dishwasher Repair, Microwave Repair, Refrigerator Repair, Dryer Repair, Washer Repair, Ice-Maker Repair, Oven Repair, Freezer Repair, Range Repair and Stove Repair. One important fact to keep in mind is the exceptional work matched by years of experience delivered by our skilled technicians in the best repair experience for all clients. Our repairs of appliances are all trustworthy and affordable to meet your budget demand. The simple fact is that our repair service would aid you achieve the best quality service within the shortest possible time. Our same-day repair service and the use of a local team of technicians provide the additional edge to meet every customers demand.<p>Our Appliance Repair Company provides countless benefits for both residential and commercial customers in the service area. There are no other appliance repair companies that can serve you like we do.</p>
                    </div>
                    <div class="col-lg-6">
                        <amp-img layout="responsive" width="525" height="405" src="{{ asset('/assets/front/images/services/168-used-sd.jpg') }}" alt="appliance repairman"></amp-img>
                    </div>
                </div>
                <div class="row article-item">
                    <div class="col-12">
                        <p>Dishwasher Repair <a href="https://www.lacity.org" rel="dofollow" target="_blank">Los Angeles</a> Ca has been in the Dishwasher industry for a long time and is well versed in all forms of repairs. You should expect the following from us when you ask us for a dishwasher repair job:</p>
                        <h6>Fast response:</h6>
                        <p>We know that our job is meaningful because the utensils will easily spoil inside an unsuitable device. At Dishwasher Repair Los Angeles Ca, we will make every effort to respond quickly and to arrive at your location on schedule.</p>
                        <h6>High-quality service:</h6>
                        <p>Our experts are attentive and skilled in <strong>Dishwasher Repair Los Angeles Ca</strong>. Before they consider their job finished, they will identify the source of the problem, repair it, and ensure that your dishwasher is completely functional.</p>
                        <p>Finally, if you are searching for a Dishwasher Repair Los Angeles Ca technician, you need to be as detailed as possible. And if you don't know how a dishwasher works, the Dishwasher Repair Los Angeles Ca technician will provide you with information on the Dishwasher brand in Los Angeles Ca. It makes us understand the issue and the Los Angeles Ca Dishwasher can serve you as quickly as possible.</p>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="testimonials-item">
                            <div class="headline">
                                <h6>Victor Rice</h6>
                                <amp-img width="40" height="40" src="{{ asset('/assets/front/images/logo-facebook.png') }}" alt="facebook"></amp-img>
                            </div>
                            <amp-img width="87" height="14" src="{{ asset('/assets/front/images/stars.svg') }}" alt="5 star rating"></amp-img>
                    ...
                    <div class="col-lg-4">
                        <div class="testimonials-item">
                            <div class="headline">
                                <h6>Carlos Mason</h6>
                                <amp-img width="40" height="40" src="{{ asset('/assets/front/images/logo-google.png') }}" alt="google"></amp-img>
                            </div>
                            <amp-img width="87" height="14" src="{{ asset('/assets/front/images/stars.svg') }}" alt="5 star rating"></amp-img>
                    ...
                    <div class="col-lg-4">
                        <div class="testimonials-item">
                            <div class="headline">
                                <h6>Marcus Stone</h6>
                                <amp-img width="40" height="40" src="{{ asset('/assets/front/images/logo-yelp.png') }}" alt="yelp"></amp-img>
                            </div>
                            <amp-img width="87" height="14" src="{{ asset('/assets/front/images/stars.svg') }}" alt="5 star rating"></amp-img>
        ...
        <section class="appointment" id="book">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <x-contact-form />
{{--                        <form class="order-form" action="/documentation/examples/api/submit-form-input-text-xhr" target="_top">--}}
...
{{--                        </form>--}}
                    ...
                    <div class="col-lg-6">
                        <amp-img layout="responsive" width="540" height="121" src="{{ asset('assets/front/images/rating.webp') }}" alt="rating"></amp-img>
                        <h4>You can find us here</h4>
                        <amp-iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d423286.27405770525!2d-118.69192047471653!3d34.02016130653294!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x80c2c75ddc27da13%3A0xe22fdf6f254608f4!2sLos%20Angeles%2C%20CA%2C%20USA!5e0!3m2!1sen!2sua!4v1622931508186!5m2!1sen!2sua" width="540" height="450" style="border:0;" sandbox="allow-scripts allow-same-origin" layout="responsive" allowfullscreen=""></amp-iframe>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="locations">
            <div class="container">
                <div class="row">
                    <div class="col">
                        <h3>Dishwasher Service Los Angeles CA covers all the following areas:</h3>
                        ...
                        <h3>Our Dishwasher Repair Service is also available in the following cities:</h3>

@extends('front.layouts.locationlayout-amp')
...
@section('content')
    ...
    <section class="article">
        <div class="container">
            @if($location->content_1)
                <div class="row article-item">
                    <div class="col-lg-6">
                        <amp-img layout="responsive" width="525" height="405" src="{{ $location->image_1 }}" alt="@if($location->image_1){{ $location->title }}@endif"></amp-img>
                    </div>
                    <div class="col-lg-6">
                        {!! $location->content_1 !!}
                    </div>
            ...
            @endif
            @if($location->content_2)
            <div class="row article-item">
                <div class="col-lg-6">
                    {!! $location->content_2 !!}
                </div>
                <div class="col-lg-6">
                    <amp-img layout="responsive" width="525" height="405" src="{{ $location->image_2 }}" alt="@if($location->image_2){{ $location->title }}@endif"></amp-img>
                </div>
            </div>
            <div class="row">
                <div class="col-12">
            ...
            @endif
            @if($location->content_3)

            <div class="row article-item">
                <div class="col-lg-6">
                    <amp-img layout="responsive" width="525" height="405" src="{{ $location->image_3 }}" alt="@if($location->image_3){{ $location->title }}@endif"></amp-img>
                </div>
                <div class="col-lg-6">
                    {!! $location->content_3 !!}
                </div>
            ...
            @if($location->content_4)
            <div class="row article-item">
                <div class="col-lg-6">
                    {!! $location->content_4 !!}
                </div>
                <div class="col-lg-6">
                    <amp-img layout="responsive" width="525" height="405" src="{{ $location->image_4 }}" alt="@if($location->image_4){{ $location->title }}@endif"></amp-img>
                </div>
            </div>
            <div class="row">
                <div class="col-12">
...
{{--                    </form>--}}
                ...
                <div class="col-lg-6">
                    ...
                    <amp-iframe src="{{ $location->iframe }}" width="540" height="450" style="border:0;" sandbox="allow-scripts allow-same-origin" layout="responsive" allowfullscreen=""></amp-iframe>
                </div>
            </div>
        </div>
    </section>

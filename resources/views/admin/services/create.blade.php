                    ...
                    <div class="col-12">
                        <div class="box box-primary">
                            <div class="box-header with-border">
                                <h3 class="box-title">Adding service</h3>
                            </div>
                            <!-- /.box-header -->
                            <!-- form start -->
                            <form role="form" method="POST" action="{{ route('service.store') }}" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    ...
                                    <!-- Location -->
                                    <h5 class="text-left text-uppercase text-red"><u>Service title</u></h5>
                                    <div class="form-group">
                                        <label for="title"></label>
                                        <input type="text" name="title" class="form-control @error('title') is-invalid @enderror" id="title" placeholder="Location title">
                                    </div>
                                    <!-- background Image -->
